package com.thornBird.sbd.aspect;
...
public class ControllerAspect {
	 ...
	 */
	@Pointcut("execution(public * com.thornBird.sbd.modules.*.controller.*.*(..))")
	@Order(1)
	public void controllerPointCut() {}
	
	@Before(value = "com.thornBird.sbd.aspect.ControllerAspect.controllerPointCut()")
	 ...
	 */
	@Around(value="com.thornBird.sbd.aspect.ControllerAspect.controllerPointCut()")
	 ...
	 * -后置通知
	 */
	@After(value="com.thornBird.sbd.aspect.ControllerAspect.controllerPointCut()")
